...
- Started `WI-1198` to compact the filing blocker card so failed checks, warnings, and next actions read as one operator-priority block beside the filing workspace.
