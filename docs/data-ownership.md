...
| Scheduling | `WorkSchedule`, `WorkScheduleTemplate` | `scheduling.schedule.assigned.v1`, `scheduling.schedule.updated.v1`, `scheduling.schedule.deleted.v1`, `scheduling.template.created.v1`, `scheduling.template.assigned.v1`, `scheduling.template.range_assigned.v1`, `scheduling.rotation.assigned.v1`, `scheduling.anomaly.detected.v1`, `scheduling.anomaly.escalated.v1`, `scheduling.anomaly.ticket.requested.v1` | Own tables, read-only via API/event projections |
