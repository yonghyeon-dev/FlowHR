...
| Approval | `ApprovalPolicy`, `ApprovalDelegation`, `ApprovalLineTemplate`, `ApprovalStageHistory` | `approval.policy.updated.v1`, `approval.delegation.created.v1`, `approval.delegation.updated.v1`, `approval.template.created.v1`, `approval.template.updated.v1` | Own tables, read-only via API/event projections |
...
| Leave | `LeaveRequest`, `LeaveApproval`, `LeaveBalanceProjection`, `LeavePolicy` | `leave.requested.v1`, `leave.approved.v1`, `leave.rejected.v1`, `leave.canceled.v1`, `leave.accrual.settled.v1`, `leave.policy.updated.v1` | Own tables, attendance/payroll read-model only |
