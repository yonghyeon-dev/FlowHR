...
| Contracts | none (audit-log snapshot model) | `contract.template.created.v1`, `contract.template.updated.v1`, `contract.document.created.v1`, `contract.document.approval.requested.v1`, `contract.document.approval.decided.v1`, `contract.document.sent.v1`, `contract.document.responded.v1`, `contract.document.expired.v1`, `contract.document.renewed.v1` | Read-only through contracts API/event projections |
