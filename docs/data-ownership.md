...
| Approval | `ApprovalPolicy`, `ApprovalDelegation` | `approval.policy.updated.v1`, `approval.delegation.created.v1`, `approval.delegation.updated.v1` | Own tables, read-only via API/event projections |
