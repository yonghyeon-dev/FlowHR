...
| Ref | Surface | Current | Desired | Status |
| --- | --- | --- | --- | --- |
| J1 | Employee focus deep links | Desktop direct-load gaps remained across focus targets | Stable direct-load and client-side section navigation | Partial -> WI-1033, WI-1034, WI-1035, WI-1036, WI-1043, WI-1048, follow-up WI-1059 |
