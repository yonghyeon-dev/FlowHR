...
33. Recalculate year-end settlement with deduction-item inputs and verify baseline-vs-recalculated tax/liability delta output plus year-end deduction item caps breakdown.
