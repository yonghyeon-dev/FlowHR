...
async function run() {
  ...
  assert.doesNotMatch(adminPanels, /from "@\/components\/admin-dashboard\/AdminSchedulingPanel"/);
  assert.doesNotMatch(adminPanels, /from "@\/app\/admin\/page-compensation-panels"/);
  assert.doesNotMatch(adminPanels, /<AdminOnboardingAccountPanels/);
  ...
  assert.doesNotMatch(adminCompensationPanels, /from "@\/components\/admin-dashboard\/AdminPayrollWorkspaceCard"/);
  assert.doesNotMatch(adminCompensationPanels, /<AdminAggregateLeavePanels/);
  assert.doesNotMatch(adminCompensationPanels, /<AdminPayrollWorkspaceCard/);
