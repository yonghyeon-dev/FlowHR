...
export type ClosurePacketReleaseDigestAckLedgerGateState = {
...
export type ClosurePacketReleaseDigestAckLedgerDraft = {
...
export type ClosurePacketReleaseDigestAckChannelDraft = {
...
export const CLOSURE_PACKET_RELEASE_DIGEST_ACK_CHANNEL_LABELS: Record<
  ClosurePacketReleaseDigestAckChannel,
  string
> = {
  ops_ack_desk: "Ops Ack Desk",
  finance_ack_desk: "Finance Ack Desk",
  audit_ack_desk: "Audit Ack Desk"
};

export const CLOSURE_PACKET_RELEASE_DIGEST_ACK_LEDGER_GATE_FIELDS: ReadonlyArray<{
  key: keyof ClosurePacketReleaseDigestAckLedgerGateState;
  label: string;
}> = [
...
export function buildClosurePacketReleaseDigestAckLedgerGateState(params: {
...
}): ClosurePacketReleaseDigestAckLedgerGateState {
  return {
...
export function buildClosurePacketReleaseDigestAckChannelDraftMap(
  ...
  return entries.reduce(
    ...
    {} as Record<ClosurePacketReleaseDigestAckChannel, ClosurePacketReleaseDigestAckChannelDraft>
  );
}
