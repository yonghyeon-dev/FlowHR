...
const adminContractsCopyEn = {
  ...
  nextStepFilterLabel: "Next-step filter",
  nextStepAllOption: "All steps",
  nextStepSummaryLabel: "Next-step queue",
...
export const adminContractsCopyByLocale: Record<FlowLocale, AdminContractsCopy> = {
  ko: {
    ...
    expiresPrefix: "만료",
    nextStepLabel: "다음 단계",
    nextStepFilterLabel: "다음 단계 필터",
    nextStepAllOption: "전체 단계",
    nextStepSummaryLabel: "다음 단계 큐",
...
const employeeContractsCopyEn = {
  ...
  inboxDeadlineFilterActionNeededOption: "Action needed",
  ...
  actionNeededCountLabel: "Action needed",
  ...
  riskQuickActionNeededAction: "Action needed",
...
export const employeeContractsCopyByLocale: Record<FlowLocale, EmployeeContractsCopy> = {
  ko: {
    ...
    inboxDeadlineFilterActionNeededOption: "조치 필요",
    ...
    actionNeededCountLabel: "조치 필요 건",
    ...
    riskQuickActionNeededAction: "조치 필요",
