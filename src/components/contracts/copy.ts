...
const adminContractsCopyEn = {
  ...
  analyticsSourceBanner: "Opened from admin analytics",
  analyticsSourceFocusLabel: "Focused metric",
  ...
  payrollBackLabel: "Back to payroll lane",
  ...
  pendingResponseQueueLabel: "Pending response",
...
export const adminContractsCopyByLocale: Record<FlowLocale, AdminContractsCopy> = {
  ko: {
    ...
    analyticsSourceBanner: "관리자 분석 화면에서 이동했습니다",
    analyticsSourceFocusLabel: "집중 지표",
    ...
    pendingResponseQueueLabel: "응답 대기",
...
const employeeContractsCopyEn = {
  ...
  deadlineStatusNone: "No deadline",
  deadlineStatusNormal: "On track",
  deadlineStatusDueSoonPrefix: "Due soon",
  deadlineStatusOverduePrefix: "Overdue",
  selectAction: "Select",
  ...
  responseHistoryEvidenceFormatJsonLabel: "JSON evidence",
  responseHistoryEvidenceFormatTextLabel: "Text evidence",
...
export const employeeContractsCopyByLocale: Record<FlowLocale, EmployeeContractsCopy> = {
  ko: {
    ...
    approvalPrefix: "승인",
    expiresPrefix: "만료",
    expiresAtLabel: "응답 기한",
    deadlineStatusLabel: "기한 상태",
    deadlineStatusNone: "해당 없음",
    deadlineStatusNormal: "정상",
    deadlineStatusDueSoonPrefix: "응답 임박",
    deadlineStatusOverduePrefix: "기한 초과",
    selectAction: "선택",
    responseTitle: "응답",
    ...
    responseHistoryEvidenceFormatJsonLabel: "구조 데이터 증빙",
    responseHistoryEvidenceFormatTextLabel: "텍스트 증빙",
