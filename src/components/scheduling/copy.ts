...
export const adminSchedulingCopyByLocale: Record<FlowLocale, AdminSchedulingCopy> = {
  ko: {
    ...
    filtersTitle: "조회 조건",
    organizationIdLabel: "작업 조직",
    actorIdLabel: "관리자 계정",
    accessTokenLabel: "액세스 토큰(선택)",
    employeeIdLabel: "조회 대상 직원",
    fromDateLabel: "조회 시작일",
    toDateLabel: "조회 종료일",
    loadAction: "일정 조회",
    createTitle: "일정 생성",
    createEmployeeIdLabel: "직원",
    ...
    incidentAssigneeIdLabel: "담당자(선택)",
    ...
    incidentActionAssigneeLabel: "조치 담당자",
    ...
    okLabel: "성공",
    failLabel: "실패",
    statusNeedsOrganization: "작업할 조직을 먼저 선택해 주세요.",
    statusNeedsEmployee: "직원을 먼저 선택해 주세요.",
    ...
    statusIncidentNeedsAssignee: "담당자를 지정해 주세요.",
  ...
  en: {
    ...
    organizationIdLabel: "Working organization",
    ...
    createEmployeeIdLabel: "Employee",
    ...
    incidentAssigneeIdLabel: "Assignee (optional)",
    ...
    incidentActionAssigneeLabel: "Action assignee",
    ...
    okLabel: "OK",
    failLabel: "FAIL",
    statusNeedsOrganization: "Choose an organization first.",
    statusNeedsEmployee: "Choose an employee first.",
    ...
    statusIncidentNeedsAssignee: "Choose an assignee before assigning.",
...
export const employeeScheduleCopyByLocale: Record<FlowLocale, EmployeeScheduleCopy> = {
  ko: {
    ...
    filtersTitle: "조회 조건",
    organizationIdLabel: "세션 조직",
    employeeIdLabel: "세션 직원",
    fromDateLabel: "조회 시작일",
    toDateLabel: "조회 종료일",
    accessTokenLabel: "액세스 토큰(선택)",
    loadAction: "내 일정 조회",
    ...
    failLabel: "실패",
    statusNeedsRange: "조회 기간을 입력하세요.",
    statusNeedsOrgDev: "개발 헤더 모드에서는 작업 조직이 필요합니다.",
  ...
  en: {
    ...
    filtersTitle: "Filters",
    organizationIdLabel: "Session organization",
    employeeIdLabel: "Session employee",
    fromDateLabel: "From date",
    toDateLabel: "To date",
    accessTokenLabel: "Access Token (optional)",
    ...
    failLabel: "FAIL",
    statusNeedsRange: "from/to date is required.",
    statusNeedsOrgDev: "A working organization is required in dev header mode.",
