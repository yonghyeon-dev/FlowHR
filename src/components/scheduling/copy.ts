...
export const adminSchedulingCopyByLocale: Record<FlowLocale, AdminSchedulingCopy> = {
  ko: {
    ...
    filtersTitle: "조회 조건",
    organizationIdLabel: "작업 공간 상태",
    actorIdLabel: "관리자 세션 상태",
  ...
  en: {
    ...
    organizationIdLabel: "Workspace status",
    actorIdLabel: "Admin session status",
...
export const employeeScheduleCopyByLocale: Record<FlowLocale, EmployeeScheduleCopy> = {
  ...
  en: {
    ...
    filtersTitle: "Filters",
    organizationIdLabel: "Workspace status",
    employeeIdLabel: "Employee session status",
    fromDateLabel: "From date",
    toDateLabel: "To date",
    accessTokenLabel: "Access Token (optional)",
