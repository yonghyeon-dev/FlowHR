...
export type PayrollPayslipDeliveryCopy = typeof payslipDeliveryCopyEn;

export const payrollPayslipDeliveryCopyByLocale: Record<FlowLocale, PayrollPayslipDeliveryCopy> = {
  ko: {
    ...payslipDeliveryCopyEn,
    heroEyebrow: "FlowHR 관리자",
    title: "급여명세 배포",
    description: "확정된 급여명세를 배포하고 직원 수신 확인 전 단계 상태를 점검합니다.",
    inputTitle: "배포 입력",
    periodStartLabel: "기간 시작",
    periodEndLabel: "기간 종료",
    employeeIdOptionalLabel: "직원 ID (선택)",
    employeeIdPlaceholder: "EMP-1001",
    ...
    runIdsTitle: "Run ID",
    noRunIdsYet: "아직 Run ID가 없습니다.",
    targetRunsLabel: "대상 Run",
    alreadyDistributedRunsLabel: "기배포 Run",
    newlyDistributedRunsLabel: "신규 배포 Run",
    apiLogsTitle: "API 로그",
    apiLogsTotalLabel: "총",
