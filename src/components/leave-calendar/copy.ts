...
export const leaveCalendarCopyByLocale: Record<FlowLocale, LeaveCalendarCopy> = {
  ko: {
    ...
    adminActorIdFallbackLabel: "관리자 Actor ID(dev fallback)",
  ...
  en: {
    ...
    noQueryResultYet: "No query result yet.",
    ...
    pendingLeaveCalendarQuery: "leave calendar query",
    logLeaveCalendarQuery: "leave calendar query",
