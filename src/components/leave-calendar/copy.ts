...
export const leaveCalendarCopyByLocale: Record<FlowLocale, LeaveCalendarCopy> = {
  ko: {
    ...
    departmentIdOptionalLabel: "대상 부서(선택)",
    fromLabel: "시작일",
    toLabel: "종료일",
    ...
    adminActorIdFallbackLabel: "관리자 계정(개발용 대체값)",
  ...
  en: {
    ...
    departmentIdOptionalLabel: "Department (optional)",
    fromLabel: "From",
    toLabel: "To",
    ...
    adminActorIdFallbackLabel: "Admin account (dev fallback)",
