    ...
    return [
      {
        ...
        links: [
          { href: "/employee/requests#attendance-actions", label: "출퇴근 정정 요청" },
      ...
      },
      {
        ...
        links: [
          { href: "/employee/requests#leave-actions", label: "휴가 요청 센터" },
  ...
  return [
    {
      ...
      links: [
        { href: "/employee/requests#attendance-actions", label: "Attendance requests" },
    ...
    },
    {
      ...
      links: [
        { href: "/employee/requests#leave-actions", label: "Leave requests hub" },
