...
const defaultCopy: EmployeeGuideCopy = {
  ...
  quickActions: [
    { label: "Attendance", href: "/employee/attendance?source=employee-guide", description: "Check-in/check-out and correction request." },
    { label: "Leave", href: "/employee/leave?source=employee-guide", description: "Submit leave request and track status." },
...
export const employeeGuideCopyByLocale: Record<FlowLocale, EmployeeGuideCopy> = {
  ko: {
    ...
    quickActions: [
      { label: "근태", href: "/employee/attendance?source=employee-guide", description: "출퇴근 기록/정정 요청을 처리합니다." },
      { label: "휴가", href: "/employee/leave?source=employee-guide", description: "휴가 요청을 등록하고 상태를 확인합니다." },
