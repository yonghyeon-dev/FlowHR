...
export default function MvpConsolePage() {
  ...
  return (
    <main className="console-page">
      <section className="hero-panel">
        <p className="eyebrow">FlowHR 검증 콘솔</p>
        <h1>출퇴근, 휴가, 급여 API를 한 화면에서 검증합니다.</h1>
        ...
        <div className="hero-meta">
          ...
          <Link href="/">커맨드 센터</Link>
          <Link href="/ops/scheduling-cockpit">스케줄링 Cockpit</Link>
        </div>
      </section>
