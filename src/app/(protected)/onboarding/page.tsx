  ...
  const copy = useMemo(() => {
    if (isKoLocale) {
      return {
        ...
        missingOrganizationIdNotice: "세션에서 조직 ID를 확인할 수 없습니다. /login에서 다시 로그인해 주세요.",
    ...
    return {
      ...
      missingOrganizationIdNotice: "Organization ID is missing in the session. Please sign in again at /login.",
