...
export function resolvePayslipPageCopy(isKoLocale: boolean): PayslipPageCopy {
  if (isKoLocale) {
    return {
      ...
      detail: {
        ...
        printVerificationTitle: "출력 검증",
        printVerificationExpectedNet: "검증 실수령(총지급-총공제)",
        printVerificationActualNet: "명세 실수령",
        printVerificationResult: "검증 결과",
        printVerificationPass: "일치",
        printVerificationFail: "불일치",
        withholdingTax: "원천세",
  ...
  return {
    ...
    devTools: {
      ...
      sessionActorLabel: "Employee session status",
      callCount: "Calls",
      current: "Current",
      session: "Session",
      none: "none",
    ...
    detail: {
      ...
      printVerificationTitle: "Print verification",
      printVerificationExpectedNet: "Expected net (gross - deduction)",
      printVerificationActualNet: "Payslip net",
      printVerificationResult: "Verification",
      printVerificationPass: "Balanced",
      printVerificationFail: "Mismatch",
