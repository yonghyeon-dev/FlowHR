import { listScheduleRotationBalanceQuerySchema } from "@/features/scheduling/schemas";
import { listWorkScheduleRotationBalance } from "@/features/scheduling/service";
...
export async function GET(request: Request) {
  ...
  const parsed = listScheduleRotationBalanceQuerySchema.safeParse({
  ...
  try {
    const report = await listWorkScheduleRotationBalance(
      {
