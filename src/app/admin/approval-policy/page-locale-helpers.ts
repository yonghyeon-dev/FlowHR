...
const COPY_BY_LOCALE: Record<"ko" | "en", AdminApprovalPolicyLocaleCopy> = {
  ko: {
    hero: {
      eyebrow: "FlowHR 관리자",
      title: "결재/위임 정책",
      description: "도메인별 기본 결재 role과 임시 위임 정책을 설정합니다.",
      devNotice: "개발 도구 모드에서는 헤더 기반 Actor 컨텍스트를 사용합니다."
    },
    context: {
      title: "컨텍스트",
    ...
    policy: {
      title: "도메인별 결재 role",
      attendanceApproverRole: "근태 승인 role",
      leaveApproverRole: "휴가 승인 role",
      payrollApproverRole: "급여 확정 role",
      savePolicy: "정책 저장"
    },
    delegationCreate: {
      title: "위임 생성",
      domain: "도메인",
      delegatorRole: "위임자 role",
      delegateActorId: "수임 Actor ID",
      startsAt: "시작 시각",
      endsAt: "종료 시각",
