    ...
    <div className="saas-shell">
      <aside className="saas-sidebar">
        ...
        <nav className="saas-nav" aria-label="관리자 네비게이션">
          ...
          <Link href="/admin/people#history-sort-hardening">People 이력 정렬 보강</Link>
          <Link href="/admin/people#history-sort-hardening-plus">People 이력 정렬 보강+</Link>
          <Link href="/admin/people#history-sort-hardening-plus-execution">People 이력 정렬 보강+ 실행</Link>
          ...
          <Link href="/admin/people#history-delay-risk-response">People 변경 지연 위험 대응</Link>
          <Link href="/admin/people#history-delay-risk-response-execution-guide">People 변경 지연 대응 실행 가이드</Link>
          <Link href="/admin/people#history-delay-risk-response-execution-tracker">People 변경 지연 대응 실행 추적</Link>
          ...
          <Link href="/admin/people#history-execution-summary-digest">People 이력 실행 요약 다이제스트</Link>
          <Link href="/admin/people#history-delay-risk-execution-backlog">People 변경 지연 실행 백로그</Link>
          <Link href="/admin/people#history-delay-execution-backlog-digest">People 변경 지연 백로그 다이제스트</Link>
          <Link href="/admin/people#people-mobile-follow-up-recommendation-upgrade-4">People 모바일 추천 고도화 4</Link>
          <Link href="/admin/people#people-mobile-follow-up-recommendation-upgrade-5">People 모바일 추천 고도화 5</Link>
          ...
          <Link href="/admin#approval-delay-risk-execution-backlog">승인 지연 실행 백로그</Link>
          <Link href="/admin#approval-delay-execution-backlog-digest">승인 지연 실행 백로그 다이제스트</Link>
