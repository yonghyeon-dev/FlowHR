...
const COPY_BY_LOCALE: Record<"ko" | "en", AdminApprovalHistoryLocaleCopy> = {
  ko: {
    ...
    filters: {
      ...
      domain: "도메인",
      targetEntityType: "요청 분류",
      targetEntityTypePlaceholder: "예: 출퇴근 정정, 휴가 신청, 급여 승인",
      targetEntityId: "요청 번호",
      allowed: "허용 여부",
      resolution: "해결 유형",
      limit: "조회 개수",
      all: "전체",
  ...
  en: {
    ...
    filters: {
      ...
      domain: "Domain",
      targetEntityType: "Request subtype",
      targetEntityTypePlaceholder: "Attendance correction / Leave request / Payroll approval",
      targetEntityId: "Request number",
      allowed: "Allowed",
