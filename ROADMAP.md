...
- 근무일정/교대/유연근무 고도화(로테이션 자동 최적화/write-back)
...
| **근무일정** | ✅ 교대근무/유연근무 | ✅ 시차출근/재택 | ⚠️ WorkSchedule CRUD + template 단건/다건 + rotation assign/balance baseline(WI-0040~0047, WI-0057); 자동 최적화/write-back 미도입 | Critical |
