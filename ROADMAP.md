...
| **근무일정** | ✅ 교대근무/유연근무 | ✅ 시차출근/재택 | ⚠️ WorkSchedule CRUD + template 단건/다건 할당 baseline(WI-0040~0046); 로테이션/밸런싱 미도입 | Critical |
