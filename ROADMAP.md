...
- 실시간 근태 현황 고도화(incident read model/list/timeline + 운영 runbook 자동화)

### 진행 중

- 없음 (WI-0072까지 main 반영 기준)
...
| **근태 집계** | ✅ 자동 집계/이상 감지 | ✅ 실시간 대시보드 | ⚠️ 집계 조회 API(WI-0031) + anomaly 리포트/알림/에스컬레이션 + cockpit/ticket/stream + ops dashboard/incident stream automation + incident lifecycle commands(WI-0045, WI-0051, WI-0055, WI-0065, WI-0067, WI-0068, WI-0071, WI-0072); incident read model/list/timeline 미도입 | Medium |
