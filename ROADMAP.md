...
> **Current version**: 0.1.102 (Mobile Push Notification Baseline)
...
- 다음: 모바일 이메일 템플릿 엔진 baseline(`WI-V`) 착수 (WI-0242 예정)
...
| 모바일 | ⚠️ `apps/mobile` 셸 + 푸시 권한/선호/알림센터 baseline (WI-0241) | 네이티브 앱 (iOS/Android) |
