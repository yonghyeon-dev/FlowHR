...
| **근무일정** | ✅ 교대근무/유연근무 | ✅ 시차출근/재택 | ⚠️ WorkSchedule CRUD + template 단건/다건 + rotation assign/balance/optimize baseline(WI-0040~0047, WI-0057, WI-0058); 다직원 글로벌 fairness 최적화 미도입 | High |
