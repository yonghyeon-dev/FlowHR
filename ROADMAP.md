...
- 출퇴근 정책 고도화(디바이스 검증 고도화/다중 사업장 지오펜스)
- 실시간 근태 현황 고도화(리포트/알림 baseline 이후 대시보드/에스컬레이션)

### 진행 중

- 없음 (WI-0052까지 main에 머지 완료 기준)
...
| **출퇴근** | ✅ GPS/비콘/키오스크 | ✅ GPS/Wi-Fi/QR | ⚠️ 채널 메타데이터 + GPS/지오펜스/디바이스 allowlist baseline(WI-0048~0052) 완료, 다중 사업장/attestation 미도입 | High |
